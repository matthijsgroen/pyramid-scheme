...
- A new puzzle for the harder journeys: the same star grid, but every row, column and region holds TWO stars. Twice as much to place, and a row is never finished until both of its stars are down.
