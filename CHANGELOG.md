...
- Both of the priest's gods keep shrines in his tomb — Anubis standing in the cabinet, Thoth's ibis
  coiled in its own — where every other shrine at that rank holds a household god. His rank is the third
  of five whose patron art is finished as well as its furniture.
...
- Sand blows in rather than being laid down: real wind-rippled sand, spread across several cells and
...
- What a prop stands in is a shadow rather than a hole: the floor's own paving, joints and grit show
  through it now, and it is the colour of that floor in shade rather than of some other tomb's.
...
- A false door stands in the nobleman's walls: a painted limestone stela cut as a doorway that leads
  nowhere, its columns of offering formula worn back to the red ochre in the cuts.
- A lamp niche is cut into the nobleman's chapel walls: one clay lamp burning in it, a second waiting
  cold, the oil jar they are filled from, and years of soot fanned up the stone above the flame.
...
- The way into a chamber is a timber gateway now: two rough-hewn posts and a heavy beam across them, its
  top face catching the light and its underside in shadow. Brown wood against grey stone, so a doorway is
  something you see rather than a paler patch of wall. Where a doorway is also the seam between two tombs,
  the sill is laid under it and the gateway stands on the step.
...
- A doorway stands on the floor now: its posts throw a shadow you walk over, while the gateway itself
  still passes in front of you as you go under it.
- A nobleman's doorway is cut from his own walls: plastered jambs and a lintel with its top face catching
  the light, standing a little proud of the wall it pierces.
- The sill at a nobleman's doorway is one cut block of his own limestone, dished by feet, a line of red
...
- A merchant's chamber holds his goods: a timber rack of sealed wine and oil jars with one leaning
  against its neighbour, his trading table with a balance and a heap of grain, a water jar on its stand,
  and a small worn shabti standing knee-high beside them — the cheap mass-made figurine a poor man was
  buried with, its paint long gone.
...
- The gods' floor is green calcite lit from underneath, with points of light set in it like stars.
  Nobody laid it: a seam appears here and there as though a slab were about to form, runs a little way
  and stops in open stone, light leaking up through it. There is no dust, no chip and no crack anywhere
  on it — the only ground in the game nothing has ever worn.
...
- A pharaoh's chamber walls are polished black granite dressed with gold: a row of royal cartouches,
  each a gold ring around signs cut into the stone, over a fine chequered ribbon of gold and granite
  inlay. The darkest wall in the game, and the only one where the decoration is metal rather than paint.
