...
- A new puzzle: place one star in every row, column and walled-off region of the grid, with no two stars ever touching. The walls are the only clue, and every square is yours to fill.
