...
- You place the pieces yourself. A piece you find is carried until you set it in: the mosaic screen shows a "Place 4 pieces" button, and tapping it drops them into the window one at a time, lowest scene first, each one flaring as it lands. So a scene finishing — and lighting up — is the end of something you did, not something that happened while you were somewhere else.
- Fez tells you what you just finished. Setting the last piece of a scene stops the placing, lights the panel, and he says his three lines about it — who the cat in the doorway is, why the king is green, what the feather on the scale means. Finish the whole window and he steps back and looks at all five with you. Placing resumes afterwards with whatever is still in your hands.
