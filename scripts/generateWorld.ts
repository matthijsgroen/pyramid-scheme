...
import { CAPPED_CURRENCIES, CONSUMABLES } from "../src/mods/registeredMods"
...
const configs = buildConfigs(resolveKeyRequirements, ALL_CURRENCY_DISTRIBUTIONS, CAPPED_CURRENCIES, CONSUMABLES)
