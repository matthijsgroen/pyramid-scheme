...
3. **Patron art — twenty-one entries left, and seven of them can be painted today.** `yarn art-census` grew
   ...
   **Seven still owed have a painted generic under them, worth 81 rooms, and six of the seven are the
   ...
   `wizard/wallShrine-maat` at 19, `master/statue-osiris` at 13 — and each entry names what it waits on.
   ...
   **Two gods per rank is the floor for any of it to show**, because a patron tells one pyramid from
   ...
   decoration into 79. The merchant is still in the old position: Bastet is his only visible god, so his
