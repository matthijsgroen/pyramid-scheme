...
/**
 * Code names a design FILE, never a paragraph inside one. A § survives only until the doc is reorganised:
 * cutting the lightbeam journal (#224) left 116 references to sections that no longer existed, and nothing
 * failed. Half of what is left names no file at all, which does not even say which doc §9 is in.
 *
