...
import type { EclipsePuzzleWithAnswer } from "./generateEclipse"
 ...
 *
 * `yarn generate-boards eclipse` rewrites it. Generation is a job, not a unit test: a generator that
 ...
 */
export const FIXTURE = reviveBoards<Record<Difficulty, EclipsePuzzleWithAnswer[]>>(boards)
