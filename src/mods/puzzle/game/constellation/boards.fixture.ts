...
import type { ConstellationPuzzleWithAnswer } from "./generateConstellation"
 ...
 *
 * `yarn generate-boards constellation` rewrites it. Generation is a job, not a unit test: a generator that
 ...
 */
export const FIXTURE = reviveBoards<Record<Difficulty, ConstellationPuzzleWithAnswer[]>>(boards)
