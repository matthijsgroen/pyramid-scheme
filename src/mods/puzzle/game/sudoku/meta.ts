...
export const SUDOKU_META: FamilyMeta = {
  ...
  // register of names with nothing repeated (PUZZLE_FAMILIES.md §11.1). A tag is eligibility and
  // nothing more, so carrying the second one costs the family nothing.
  tags: ["puzzle", "scribe"],
  minTier: "starter",
