 ...
 *
 * `yarn generate-boards sudoku` rewrites it. Generation is a job, not a unit test: a generator that
 ...
 */
export const FIXTURE = reviveBoards<Record<Difficulty, SudokuPuzzle[]>>(boards)
