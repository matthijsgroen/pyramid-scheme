...
const cellCls = (view: CellView, state: { lit: boolean; movable: boolean }) =>
  // `min-h-0` for the reason star battle's board spells out: a square holding a piece sized off it would
  // otherwise claim more height than its track and spill below the board on WebKit.
  clsx(
    "relative flex aspect-square min-h-0 items-center justify-center rounded bg-stone-800 p-[8%] transition-colors",
    {
