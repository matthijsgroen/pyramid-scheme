...
// demo, futoshiki) and the crocodile capstone. A root mod: it stays on in production (turning it off leaves
...
export const puzzleMod: ModDescriptor = {
  id: "puzzle",
  families: [SUMPLETE_META, SUMPLETE_MIRROR_META, FUTOSHIKI_META, CROCODILE_META],
}
