...
/**
 * Solved when the light reaches the shrine the player named — reaching the other one is a route, not an
 * answer, and a board with no shrine named is not an answer to anything.
 */
