  ...
  junior_1: [
    {
      ...
      exitOrStaircase: "exit",
      sideSections: [{ pathPuzzles: 0, difficulty: "easy", end: "treasure", endReward: { type: "mapPiece" } }],
  ...
  expert_1: [
    {
      ...
      sideSections: [
        ...
        { pathPuzzles: 0, difficulty: "medium", end: "staircase", gate: { type: "floor-key" } },
      ],
      mainEndReward: { type: "mosaicPiece" },
      chestRewards: [
  ...
  wizard_1: [
    {
      ...
      sideSections: [
        ...
        { pathPuzzles: 0, difficulty: "hard", end: "staircase", gate: { type: "floor-key" } },
      ],
      mainEndReward: { type: "mosaicPiece" },
      chestRewards: [
