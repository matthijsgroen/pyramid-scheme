...
export const worldContentHash = 181891163
    ...
    [
      {
        ...
        sideSections: [
          ...
          { pathPuzzles: 1, difficulty: "starter", end: "treasure", endReward: { type: "mosaicPiece" }, hidden: true },
        ],
        mainEndReward: { type: "mapPiece", tombId: "starter_treasure_tomb" },
        chestRewards: [{ type: "consumable", consumable: "oil" }],
      },
    ...
    [
      ...
      },
      {
        ...
        sideSections: [
          ...
          { pathPuzzles: 2, difficulty: "wizard", end: "treasure", endReward: { type: "mosaicPiece" } },
          {
            pathPuzzles: 1,
            difficulty: "wizard",
            end: "treasure",
